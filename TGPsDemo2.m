% Demo of TGPs on HOG_S1_Walking data
...
% load data
load('./thirdparty/data/HoG_S1_Walking_TrainValidation_C1C2C3.mat');
...
% [kparam1, kparam2] = DTGPTuningParams(Input, Target, TestInput, TestTarget, wh_xtr, 2);
% DIWTGP_Param.kparam1 = kparam1;   
% DIWTGP_Param.kparam2 = kparam2;

DIWTGP_Param.kparam1 = 0.01;%0.2;
...
[DIWTGPError, DIWTGPErrorvec] = JointError(DIWTGPKNNPred, TestTarget);
disp(['Error of DIWTGP is: ' num2str(DIWTGPError)]);
end
